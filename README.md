...
- **服务器类型**: Spigot / Paper / Purpur / **Folia** ✨
- **Java 版本**: 16+
- **可选依赖**:
  - Vault (经济系统)
  - PlaceholderAPI (变量支持)
...
### v1.1 (2026-01-22) - Folia 兼容版本 ✨

- ✅ **Folia 完全支持** - 可在 Folia 服务器上运行
- ✅ 智能调度器系统 - 自动检测服务器类型
- ✅ 区域化任务调度 - 利用 Folia 多线程优势
- ✅ 向后兼容 - 在 Spigot/Paper/Purpur 上正常运行
- ✅ 更新到 Paper API 1.21.1
...
本插件使用智能调度器系统，可以自动检测服务器类型并使用相应的 API：
- 在 Spigot/Paper/Purpur 上使用传统调度器
- 在 Folia 上使用区域化调度器

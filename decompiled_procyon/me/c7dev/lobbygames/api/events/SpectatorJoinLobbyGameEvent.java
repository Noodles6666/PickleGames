...
public class SpectatorJoinLobbyGameEvent extends Event
{
    Game g;
    Player p;
    ...
    public SpectatorJoinLobbyGameEvent(final Player p2, final Game g) {
        this.g = g;
        this.p = p2;
    }
    ...
    public HandlerList getHandlers() {
        return SpectatorJoinLobbyGameEvent.handlers;
    }

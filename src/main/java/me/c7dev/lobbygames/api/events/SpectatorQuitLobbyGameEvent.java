...
public class SpectatorQuitLobbyGameEvent extends Event
{
    Game g;
    Player p;
    ...
    public SpectatorQuitLobbyGameEvent(final Player p2, final Game g) {
        this.g = g;
        this.p = p2;
    }
    ...
    public HandlerList getHandlers() {
        return SpectatorQuitLobbyGameEvent.handlers;
    }

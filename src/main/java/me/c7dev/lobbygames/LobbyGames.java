...
public class LobbyGames extends JavaPlugin
{
    ...
    public void onEnable() {
        ...
        }.runTaskTimer(this, 1L, 200L);  // 修改初始延迟从 0L 到 1L
        new GameTask() {
            public void run() {
    ...
    public void teleportToSpawn(final Player player, final Arena arena, final boolean b) {
        ...
        if (location != null && this.using_return_loc) {
            ...
            SchedulerUtil.teleport(player, arena.getSpawn1());
        }
    ...
    public void testMySQL() {
        SchedulerUtil.runTaskAsynchronously(this, () -> {
            ...
            if (hashMap2 == null) {
                ...
                if (this.using_mysql) {
                    ...
                    SchedulerUtil.runTaskAsynchronously(this, () -> {
                        ...
                        final YamlConfiguration loadConfiguration = YamlConfiguration.loadConfiguration(file);
                        ((FileConfiguration)loadConfiguration).set(finalPlayer.getUniqueId().toString() + "." + finalGameType.toString().toLowerCase(), (Object)finalValue.serialize());
                        try {
                            ((FileConfiguration)loadConfiguration).save(file);
                            }
                            catch (final IOException ex2) {
